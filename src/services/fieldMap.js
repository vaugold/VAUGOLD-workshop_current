...
export const KEY_CONFIG = {
  ...
  ws_repairs_v1: {
    ...
    // ИСПРАВЛЕНО 2026-06-27: убрали 'images' из leftover. Фото хранятся ТОЛЬКО в ws_img_v1_<id>
    // ДОБАВЛЕНО 2026-06-28: добавлен объект 'engraving' (гравировка — ТЗ, фото, суммы)
    leftover: ['clientName', 'clientPhone', 'clientEmail', 'extras', 'items', 'location', 'source', 'pickupPoint', 'engraving'],
